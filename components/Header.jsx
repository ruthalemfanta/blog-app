  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
            ...
            <p className="mt-10 max-w-[740px] m-auto text-xs sm:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi deserunt totam accusamus quaerat et veritatis. Commodi nisi iste doloribus provident voluptatum iusto, illo tempore corporis voluptates dolore, asperiores voluptatibus? Unde.
            </p>
